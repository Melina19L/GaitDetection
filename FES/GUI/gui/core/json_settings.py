...
class Settings(object):
    ...
    #app_path = os.path.abspath(os.getcwd())   #ORIGNINAL COMMAND 
    #Luka:
    # Use the folder where this file is located
    here = os.path.dirname(os.path.abspath(__file__))      # ...\GUI\gui\core
    parent = os.path.dirname(os.path.dirname(here))        # goes up to ...\GUI

    # Full path to settings.json
    settings_path = os.path.join(parent, json_file)
