...
class PyLeftMenu(QWidget):
    ...
    def toggle_animation(self):
        ...
        self.animation.stop()
        if not self.toggle_button._is_toggle_active:
            self.animation.setStartValue(self.width() + 2 * self._margin)
            self.animation.setEndValue(self._maximum_width + 2 * self._margin)
            self.toggle_button.set_active_toggle(True)
            self.toggle_button.set_icon(self._icon_path_close)
        else:
            self.animation.setStartValue(self.width() + 2 * self._margin)
            self.animation.setEndValue(self._minimum_width + 2 * self._margin)
